...
public class TwitterApp {
    ...
    public void updateStatusWithListener(String text, TweetStatusListener tweetStatusListener) {
        try {
            tweetStatusListener.onSuccess(mTwitter.updateStatus(text));
        } catch (TwitterException e) {
            e.printStackTrace();
            tweetStatusListener.onError(e.getErrorMessage());
        }
    }
